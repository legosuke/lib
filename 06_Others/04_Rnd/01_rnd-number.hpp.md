...
data:
  ...
  attributes:
    document_title: "\u4E71\u6570 (\u6570)"
    links: []
  bundledCode: "#line 2 \"06_Others/04_Rnd/01_rnd-number.hpp\"\n#include <cassert>\n\
    #include <chrono>\n#include <random>\n#include <type_traits>\n\nstruct Random\
  ...
  requiredBy:
  - 06_Others/04_Rnd/02_rnd-string.hpp
...
layout: document
redirect_from:
- /library/06_Others/04_Rnd/01_rnd-number.hpp
- /library/06_Others/04_Rnd/01_rnd-number.hpp.html
title: "\u4E71\u6570 (\u6570)"
---
