...
data:
  ...
  bundledCode: "#line 1 \"test/01_Math/01_NumberTheory/02.01.02_AOJ-ALDS1-1-C.test\
    ...
    \ true;\n}\n#line 4 \"test/01_Math/01_NumberTheory/02.01.02_AOJ-ALDS1-1-C.test\
    \ copy.cpp\"\n\nsigned main() {\n    int n; cin >> n;\n    int ans = 0;\n    for\
    \ (int i = 0; i < n; ++i) {\n        int x; cin >> x;\n        ans += is_prime(x);\n\
    \    }\n    cout << ans << endl;\n}\n"
  ...
  requiredBy: []
  timestamp: '2020-12-17 00:20:04+00:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: test/01_Math/01_NumberTheory/02.01.02_AOJ-ALDS1-1-C.test copy.cpp
layout: document
redirect_from:
- /library/test/01_Math/01_NumberTheory/02.01.02_AOJ-ALDS1-1-C.test copy.cpp
- /library/test/01_Math/01_NumberTheory/02.01.02_AOJ-ALDS1-1-C.test copy.cpp.html
