...
data:
  ...
  bundledCode: "#line 1 \"test/01_Math/01_NumberTheory/02.01.05_yukicoder-3030.test.cpp\"\
    ...
    }\n#line 4 \"test/01_Math/01_NumberTheory/02.01.05_yukicoder-3030.test.cpp\"\n\
    \nsigned main() {\n    int n; cin >> n;\n    for (int i = 0; i < n; ++i) {\n \
  ...
  verifiedWith: []
documentation_of: test/01_Math/01_NumberTheory/02.01.05_yukicoder-3030.test.cpp
layout: document
redirect_from:
- /verify/test/01_Math/01_NumberTheory/02.01.05_yukicoder-3030.test.cpp
- /verify/test/01_Math/01_NumberTheory/02.01.05_yukicoder-3030.test.cpp.html
