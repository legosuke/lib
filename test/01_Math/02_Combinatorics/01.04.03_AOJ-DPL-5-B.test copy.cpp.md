...
data:
  ...
  bundledCode: "#line 1 \"test/01_Math/02_Combinatorics/01.04.03_AOJ-DPL-5-B.test\
    ...
    \ 4 \"test/01_Math/02_Combinatorics/01.04.03_AOJ-DPL-5-B.test copy.cpp\"\n\nsigned\
    \ main() {\n    int n, k; cin >> n >> k;\n    if (n > k) {\n        cout << 0\
  ...
  verifiedWith: []
documentation_of: test/01_Math/02_Combinatorics/01.04.03_AOJ-DPL-5-B.test copy.cpp
layout: document
redirect_from:
- /library/test/01_Math/02_Combinatorics/01.04.03_AOJ-DPL-5-B.test copy.cpp
- /library/test/01_Math/02_Combinatorics/01.04.03_AOJ-DPL-5-B.test copy.cpp.html
