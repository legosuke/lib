...
data:
  ...
  bundledCode: "#line 1 \"test/01_Math/03_Algebra/01.01.01.01_AOJ-ITP1-6-D.test.cpp\"\
    ...
    \ B(A.height(), A.width());\n    for (std::uint32_t i = 0; i < A.height(); ++i)\
    \ B[i][i] = T(1);\n    while (n) {\n        if (n & 1) B = B * A;\n        A =\
    \ A * A;\n        n >>= 1;\n    }\n    return B;\n}\n#line 4 \"test/01_Math/03_Algebra/01.01.01.01_AOJ-ITP1-6-D.test.cpp\"\
    \n\nsigned main() {\n    int n, m;\n    cin >> n >> m;\n    matrix_vector<int>\
  ...
  verifiedWith: []
documentation_of: test/01_Math/03_Algebra/01.01.01.01_AOJ-ITP1-6-D.test.cpp
layout: document
redirect_from:
- /verify/test/01_Math/03_Algebra/01.01.01.01_AOJ-ITP1-6-D.test.cpp
- /verify/test/01_Math/03_Algebra/01.01.01.01_AOJ-ITP1-6-D.test.cpp.html
